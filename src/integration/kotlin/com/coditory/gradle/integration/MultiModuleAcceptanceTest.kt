...
class MultiModuleAcceptanceTest {
    companion object {
        private val parentProject = TestProjectBuilder
        ...
        private val projectA = TestProjectBuilder
            .project("project-a", parentProject.projectDir.resolve("project-a"))
            .withBuildGradle(
                """
                plugins {
                    id("java")
                ...
                application {
                    mainClass.set("com.coditory.ProjectA")
                }
                """.trimIndent(),
            )
            .withFile(
        ...
        private val projectB = TestProjectBuilder.project("project-b", parentProject.projectDir.resolve("project-b"))
            .withBuildGradle(
                ...
                application {
                    mainClass.set("com.coditory.ProjectB")
                }
                """.trimIndent(),
            )
            .withFile(
