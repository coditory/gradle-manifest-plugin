...
[![Gradle Plugin Portal](https://img.shields.io/badge/Plugin_Portal-v0.0.1-green.svg)](https://plugins.gradle.org/plugin/com.coditory.manifest)
...
- Tested on java 11 and gradle versions: 5.0, 6.2
...
```gradle
plugins {
  id 'com.coditory.manifest' version '0.0.1'
}
```
