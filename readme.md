...
[![Gradle Plugin Portal](https://img.shields.io/badge/Plugin_Portal-v0.1.2-green.svg)](https://plugins.gradle.org/plugin/com.coditory.manifest)
...
```gradle
plugins {
  id 'com.coditory.manifest' version '0.1.2'
}
```
